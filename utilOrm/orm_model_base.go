...
type OrmModelGormBase struct {
	...
	CreatedAt time.Time      `gorm:"autoCreateTime;<-:create;index:created_at" json:"created_at" form:"-"`
	UpdatedAt time.Time      `gorm:"autoUpdateTime:nano,index:updated_at" json:"updated_at" form:"-"`
