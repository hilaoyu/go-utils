...
type OrmModelGormBaseWithCU struct {
	...
	CreatedAt *OrmTime `gorm:"autoCreateTime;<-:create;index,sort:desc" json:"created_at,omitempty" form:"-"`
	UpdatedAt *OrmTime `gorm:"autoUpdateTime:nano;index,sort:desc" json:"updated_at,omitempty" form:"-"`
}
type OrmModelGormBase struct {
	OrmModelGormBaseWithCU
	DeletedAt *OrmTime `gorm:"index,sort:desc" json:"deleted_at,omitempty" form:"-"`
}
